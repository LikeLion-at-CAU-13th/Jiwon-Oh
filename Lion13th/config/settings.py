...
LOGGING = {
    ...
    'formatters': {
        'standard': {
            'format': '[%(asctime)s] %(levelname)s %(message)s', #로그 발생 시간, 로그 수준, 미들웨어에서 남긴 메세지 (요청 URL)!
        },
    },
    'handlers': {
        'console': {
...
#		'PASSWORD': DB_PW, # 비밀번호는 secrets.json에 저장 #1234
#		'HOST': 'localhost',
#		'PORT': '3306',
#	}
#}
...
###S3###
AWS_STORAGE_BUCKET_NAME = 'llion13th' # 버켓이름 잘 확인하기 ㅠㅠ 바보
